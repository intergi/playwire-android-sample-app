...
- [Usage](#usage)
  ...
  - [Additional steps on Header Bidding and Mediation](#additional-steps-on-header-bidding-and-mediation)
    - [Amazon](#amazon)
      - [Amazon Proguard](#amazon-proguard)
...
dependencies {
    ...
    implementation 'com.intergi.playwire:playwiresdk_total:11.5.0'
...
### Amazon
#### Amazon Proguard
If you are using ProGuards or another minifier, complete the following steps:
...
Add the following line to your project’s proguard-rules.pro file:
