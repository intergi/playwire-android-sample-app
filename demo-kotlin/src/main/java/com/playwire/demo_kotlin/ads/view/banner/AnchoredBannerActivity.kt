...
class AnchoredBannerActivity: AppCompatActivity() {
    ...
    private var banner: PWBannerViewAnchored? = null
    ...
    private fun loadBanner() {
        ...
        banner = PWBannerViewAnchored(this, adUnitName, listener)
        ...
        if (adWidthPixels == 0f) {
            ...
            adWidthPixels = width.toFloat()
        }
        val density = resources.displayMetrics.density
        val adWidth = (adWidthPixels / density).toInt()


        val params = PWLoadParams().withWidth(adWidth)
        banner?.load(params)
