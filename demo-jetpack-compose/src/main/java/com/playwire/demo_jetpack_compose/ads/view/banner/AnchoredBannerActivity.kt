...
class AnchoredBannerActivity : ComponentActivity() {
    ...
    fun AnchoredBannerAdView()  {
        ...
        AndroidView(factory = {
            PWBannerViewAnchored(applicationContext, adUnitName, viewModel).apply {
