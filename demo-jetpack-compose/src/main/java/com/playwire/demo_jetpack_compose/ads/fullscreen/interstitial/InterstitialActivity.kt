...
class InterstitialActivity : ComponentActivity() {
    private lateinit var viewModel: InterstitialViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = InterstitialViewModel(this, adUnitName)
        ...
        setContent {
            ...
            if (state.value == FullScreenAdState.Loaded) {
                LaunchedEffect(Unit) { viewModel.showInterstitial() }
            }
            ...
            RootScreenWithTopBar {
                Column(
                    ...
                    FullScreenAdStatus(state = state.value, mode = "interstitial", adUnitName = adUnitName)
                }
            }
        }
    }
