...
public class AnchoredBannerActivity extends AppCompatActivity {

    PWBannerViewAnchored bannerView;
    ...
    void loadBanner() {
        ...
        bannerView = new PWBannerViewAnchored(this, adUnitName, listener);
        ...
        float adWidthPixels = (float)container.getWidth();

        /// If the ad hasn't been laid out, default to the full screen width.
        if (adWidthPixels == 0f) {
            Point point = new Point();
            getWindowManager().getDefaultDisplay().getSize(point);
            adWidthPixels = (float)point.x;
        }
